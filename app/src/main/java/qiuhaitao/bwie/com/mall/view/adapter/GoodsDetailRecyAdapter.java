...
public class GoodsDetailRecyAdapter extends RecyclerView.Adapter <GoodsDetailRecyAdapter.MyViewHolder>{
    Context context;
    private List<Goods_Detail_Bean.DatasBean.GoodsCommendListBean> data = new ArrayList<>();
    private GoodsDetail_Presenter presenter;
    public GoodsDetailRecyAdapter(Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.verPromotionPriceTextView.setText(data.get(position).getGoods_promotion_price());
    ...
    public void setData(List<Goods_Detail_Bean.DatasBean.GoodsCommendListBean> data, GoodsDetail_Presenter presenter) {
        this.data = data;
